...
`-i` is no longer a necessary option, when not specified we create a temporary file into which we dump the contents of the arguments during the first run and use that as input corpus.
